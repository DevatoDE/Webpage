...
export const action: ActionFunction = async ({
  ...
  const msg = {
    to: "devato.agency@gmail.com", // Change to your recipient
    from: "info@devato.de", // Change to your verified sender
    ...
    <>
      <div className="app tracking-wide text-lg overflow-hidden">
        <div className={`${fixedWidthLayoutClasses} flex flex-col`}>
          ...
          {/* <ScrollShow />
          <div className="spacer-div xs:mt-44 sm:mt-96" id="scrollshow"></div> */}
          <MySkills />
