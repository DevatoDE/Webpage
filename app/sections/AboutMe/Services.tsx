   ...
   <div className="container">
      <div className="flex flex-wrap -mx-4">
         <div className="w-full px-4">
            <div className="text-center mx-auto mb-12 text-textSmColor lg:mb-20 max-w-[510px]">
      ...
      <div className="flex flex-wrap -mx-4">
         <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <p className="text-body-color text-lg text-text-SmColor">
                  Anhand Ihrer Vorstellungen und Ziele bauen wir einen personalisierten Shopify Store für Sie und richten Ihre Produkte oder Dienstleistungen ein.
               </p>
            </div>
         </div>
         <div className="w-full md:w-1/2 lg:w-1/3 px-4">
         ...
         <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <h4 className="font-semibold text-xl text-dark mb-3">
                  Store Speed Optimierung
               </h4>
               <p className="text-body-color text-lg text-text-SmColor">
                  Shopify Source Codes sind nicht auf Speed optimiert, obwohl dieser das Website Ranking beeinflusst.
                  Wir beschleunigen Ihre Page Loading Zeiten.
               </p>
            </div>
         </div>
         ...
         <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <p className="text-body-color text-lg text-text-SmColor">
                  Sie wollen mehr aus Ihrem Shopify Store herausholen oder einfach ein komplexes Backend Problem lösen?
                  Devato entwickelt für Sie die optimale Lösung.
               </p>
            </div>

            {/* <div className="service-button text-align:center">
            <a href="/blog">
                  <Button 
                  ghost={true}
                  color="gradient"
         ...
         <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <h4 className="font-semibold text-xl text-dark mb-3">
               Rechnungsschreibung und Buchhaltung
               </h4>
               <p className="text-body-color text-lg text-text-SmColor">
               Wir erstellen einen automatisierten und rechtsicheren Prozess von der Rechnungserstellung bis hin zur fertigen monatlichen Buchhaltung
               </p>
            </div>
         </div>
         <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <h4 className="font-semibold text-xl text-dark mb-3">
                  Bestellungs- & Daten Automation
               </h4>
               <p className="text-body-color text-lg text-text-SmColor">
                  Sie haben einen E-Commerce Store und möchten repetitive Arbeit vermeiden?
                  Devato ist Ihr Dienstleister für komplexe Automatisierung.
               </p>
            </div>
         </div>
      </div>
