...
<li className="mb-4">
<a href="https://github.com/DevatoDE?tab=repositories" className="hover:underline">Code Templates</a>
</li>
<li>
<a href="https://github.com/DevatoDE?tab=repositories" className="hover:underline">Upwork Testimonials</a>
</li>
</ul>
...
<ul className="text-gray-600 dark:text-gray-400">
<li className="mb-4">
<a href="https://devato.de/#portfolio" className="hover:underline ">Shopify Development</a>
</li>
<li className="mb-4">
<a href="https://devato.de/#portfolio" className="hover:underline">Backend Automation</a>
</li>
<li>
<a href="https://devato.de/#portfolio" className="hover:underline">Shopify Optimierung</a>
</li>
</ul>
</div>
<div>
...
<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://devato.de" className="hover:underline">Devato</a>. All Rights Reserved.
</span>
