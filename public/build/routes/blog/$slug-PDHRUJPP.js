...
} from "/build/_shared/chunk-WUIWO6JA.js";
import {
  BlogPostTags_default,
  BsFillArrowLeftCircleFill,
  tagIdsToDisplayNames
} from "/build/_shared/chunk-OJIJQVNW.js";
import {
  AUTHOR,
  IMAGE_HEIGHT,
  IMAGE_WIDTH,
...
// browser-route-module:/Users/flo/Development/Webpage/app/routes/blog/$slug.tsx?browser
init_react();

// app/routes/blog/$slug.tsx
init_react();
var React23 = __toESM(require_react());
var import_rich_text_react_renderer2 = __toESM(require_rich_text_react_renderer_es5());

// app/contentful/defaultRichTextMarkdown.tsx
init_react();
var import_react3 = __toESM(require_react());
var import_rich_text_types2 = __toESM(require_dist());
...
var HyperLink = (props) => {
  ...
  return /* @__PURE__ */ React3.createElement("a", {
    href: props.url,
    className: `BlogPost__HyperLink font-medium ${theme4 === "light" /* LIGHT */ ? "text-blue-500 hover:text-black" : "text-cyan-400 hover:text-white"} ease-in duration-100`
  }, props.children);
};
...
var CodeBlock = (props) => {
  ...
  return /* @__PURE__ */ React6.createElement("div", {
    ...
    ...defaultProps,
    theme: theme4 === "light" /* LIGHT */ ? github_default : vsDark_default,
    code: codeText,
    language
...
var HeadingOne = (props) => {
  ...
  return /* @__PURE__ */ React8.createElement("h2", {
    className: `BlogPost__HeadingOne text-4xl xs:text-5xl custom2:text-6xl mb-5 mt-5 font-medium ${theme4 === "light" /* LIGHT */ ? "text-emerald-500" : "text-teal-400"}`
  }, props.children);
};
...
var HeadingThree = (props) => {
  ...
  return /* @__PURE__ */ React10.createElement("h4", {
    className: `BlogPost__HeadingThree text-2xl font-medium xs:font-normal xs:text-3xl custom2:text-4xl leading-10 mb-5 mt-10 ${theme4 === "light" /* LIGHT */ ? "text-sky-600" : "text-sky-400"}`
  }, props.children);
};
...
var HeadingFour = (props) => {
  ...
  return /* @__PURE__ */ React11.createElement("h5", {
    className: `BlogPost__HeadingFour text-2xl xs:text-3xl mt-10 ${theme4 === "light" /* LIGHT */ ? "text-purple-500" : "text-fuchsia-400"} font-medium`
  }, props.children);
};
...
var import_rich_text_react_renderer = __toESM(require_rich_text_react_renderer_es5());
...
var Illustration = (props) => {
  ...
  const imageSrc = theme4 === "dark" /* DARK */ ? darkModeIllustrationImageSrc : lightModeIllustrationImageSrc;
  ...
  return /* @__PURE__ */ React13.createElement("div", {
    ...
    style: {
      backgroundColor: `${theme4 === "light" /* LIGHT */ ? "#ffffff" : "#0e0e0e"}`
    }
  })));
};
  ...
  renderMark: {
    [import_rich_text_types.MARKS.BOLD]: (text) => {
      ...
      return /* @__PURE__ */ import_react2.default.createElement("span", {
        className: `bold font-bold opacity-90 ${theme4 === "light" /* LIGHT */ ? "text-black" : "text-white"}`
      }, addColour([text]));
    },
  ...
  renderNode: {
    [import_rich_text_types.INLINES.HYPERLINK]: (node, children) => {
      ...
      return /* @__PURE__ */ import_react2.default.createElement("a", {
        className: `BlogPost__HyperLink ${theme4 === "dark" /* DARK */ ? "text-cyan-200 hover:text-white" : "text-cyan-700 hover:text-black"}`,
        href: node.data.uri
      }, children);
    },
...
var AuthorSection = ({}) => {
  const { theme: theme4 } = useTheme();
  const borderColor = theme4 === "light" /* LIGHT */ ? "border-gray-400" : "border-gray-200";
  ...
  }, "Verfasst von Florian Stanglmeier"), /* @__PURE__ */ React17.createElement("a", {
  ...
  }, "Florian Stanglmeier ist IT Stratege und AI Experte. Er ist zust\xE4ndig f\xFCr die Entwicklung und das Management von Projekten."), /* @__PURE__ */ React17.createElement("a", {
    href: "/",
    className: "mt-7 inline-flex items-center justify-start text-post-bodyTextLg"
  }, /* @__PURE__ */ React17.createElement("p", {
    className: "text-xl mr-5"
  }, "Mehr erfahren"), /* @__PURE__ */ React17.createElement(ArrowRightIcon_default, {
...
var Post = ({}) => {
  ...
  return /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement(FloatingHeader_default2, {
    ...
    src: theme4 === "dark" /* DARK */ ? "/svg/arrow.svg" : "/svg/arrowDark.svg",
    ...
    if (translation.data.target !== void 0) {
      ...
      return /* @__PURE__ */ React23.createElement("a", {
        ...
        className: `translation-button px-4 pt-2 pb-3 sm:px-5 sm:pt-3 sm:pb-4 ${theme4 === "light" /* LIGHT */ ? "bg-gray-100 text-black" : "bg-zinc-700 text-white"} rounded-full w-fit`
      }, language);
    }
    return null;
  })) : /* @__PURE__ */ React23.createElement("div", {
...
var TagBadge = (props) => {
  ...
  return /* @__PURE__ */ React23.createElement(React23.Fragment, null, props.theme === "light" /* LIGHT */ ? /* @__PURE__ */ React23.createElement("div", {
 ...
 * @public
 */
//# sourceMappingURL=/build/routes/blog/$slug-PDHRUJPP.js.map
