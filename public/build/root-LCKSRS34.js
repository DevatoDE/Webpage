import {
  ...
  ThemeButton_default,
  useModalContext
} from "/build/_shared/chunk-EFPC35MY.js";
import {
  AnimatePresence,
  motion,
  useReducedMotion
} from "/build/_shared/chunk-S5GVILO3.js";
import {
  require_react_dom
} from "/build/_shared/chunk-7PGEZKGC.js";
import {
  require_prop_types,
  require_react_is
} from "/build/_shared/chunk-5XRYY3A3.js";
import {
  NAVBAR_ID,
  SupportedTheme,
  ...
  useTheme
} from "/build/_shared/chunk-K7FSMQKH.js";
import {
  Link,
  Links,
  LiveReload,
  ...
  useCatch,
  useLoaderData
} from "/build/_shared/chunk-SE66QYKU.js";
import {
  React,
  __commonJS,
  __require,
  ...
  init_react,
  require_react
} from "/build/_shared/chunk-RHUZJJJM.js";
...
// app/tailwind.css
var tailwind_default = "/build/_assets/tailwind-NGYE3I5O.css";
...
var Footer = ({}) => {
  ...
  }, "Devato")), /* @__PURE__ */ React4.createElement("div", {
  ...
  }, "Navigation"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "\xDCber Uns"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "Blog und Case Studies"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "Projekte"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "Kontakt")), /* @__PURE__ */ React4.createElement("div", {
    className: "sm:w-40 md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6"
  }, /* @__PURE__ */ React4.createElement("h2", {
    className: "text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white"
  }, "Ressourcen"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "GitHub"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "React Template"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "Fallstudien"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-left text-base hover:text-gray-400 leading-none text-gray-100"
  }, "Machine Learning")), /* @__PURE__ */ React4.createElement("div", {
    className: " xl:w-72 flex justify-start items-start flex-col space-y-6"
  }, /* @__PURE__ */ React4.createElement("h2", {
    className: "text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white"
  }, "Kontakt"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-base text-left hover:text-gray-400 leading-none text-gray-100"
  }, "Devato"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-base text-left hover:text-gray-400 leading-none text-gray-100"
  }, "83646 Bad Toelz"), /* @__PURE__ */ React4.createElement("h2", {
    className: "text-base text-left hover:text-gray-400 leading-none text-gray-100"
  }, "Deutschland")))), /* @__PURE__ */ React4.createElement("div", {
  ...
  }, "2022 Devato. All Rights Reserved"), /* @__PURE__ */ React4.createElement("div", {
  ...
  }, "Datenschutz"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-base leading-none text-white hover:text-gray-300"
  }, "Impressum"), /* @__PURE__ */ React4.createElement("button", {
    className: "text-base leading-none text-white hover:text-gray-300"
  }, "Cookies"))))));
};
...
//# sourceMappingURL=/build/root-LCKSRS34.js.map
